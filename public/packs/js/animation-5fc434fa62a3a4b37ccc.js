...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function animateMaelMicout() {
    ...
    anime.timeline().add({
      ...
      complete: function complete() {
        setTimeout(animateFullStackDeveloper, 500); // Attendre 1 seconde avant de lancer l'animation pour "Full Stack Developer"
      }
    });
  }
  ...
  function animateFullStackDeveloper() {
    ...
    anime.timeline().add({
      ...
      targets: "#animation-container",
      complete: function complete() {
        setTimeout(animateMaelMicout, 500); // Attendre 1 seconde avant de lancer l'animation pour "Mael Micout"
      }
    });
  }

  setTimeout(animateMaelMicout, 500);
});

/***/ })

/******/ });
//# sourceMappingURL=animation-5fc434fa62a3a4b37ccc.js.map